...
export { START_FEN } from "@/lib/state-core";

const U_KEY_TO_FEN: Record<string, string> =
  unifiedKeys as unknown as Record<string, string>;
...
const serverKeyLookup: KeyLookup = {
  keyToFen: (key: string) => {
